...
const createCourse = async (req, res,next) => {
  ...
  try {
    ...
    const assg_result = await cloudinary.uploader.upload(review.tempFilePath, { folder: "Assignment Question",   resource_type: 'auto'  },)
    ...
    const quiz_result =await cloudinary.uploader.upload(review.tempFilePath, { folder: "Quiz Paper",   resource_type: 'auto'  },)
    ...
    const mid_result =await cloudinary.uploader.upload(review.tempFilePath, { folder: "Mid Paper",   resource_type: 'auto'  },)
    ...
    const final_result =await cloudinary.uploader.upload(review.tempFilePath, { folder: "Final Paper",   resource_type: 'auto'  },)
